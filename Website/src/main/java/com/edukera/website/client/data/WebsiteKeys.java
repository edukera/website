...
public static final String CALCULUS_TITLE = "calculus_title";
public static final String COMING_SOON = "coming_soon";
public static final String CONNECTION = "connection";
public static final String DEMONSTRATION_DESC = "demonstration_desc";
public static final String DEMONSTRATION_TITLE = "demonstration_title";
...
public static final String REASONING_DESC = "reasoning_desc";
public static final String REASONING_TITLE = "reasoning_title";
...
public static final String VALUEPROPOSITIONSECONDLINE = "valuePropositionSecondLine";
public static final String VALUEPROPOSITIONTITLE = "valuePropositionTitle";
